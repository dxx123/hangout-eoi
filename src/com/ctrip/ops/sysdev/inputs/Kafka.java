...
public class Kafka extends BaseInput {
	...
	protected void prepare() {
		...
		HashMap<String, String> consumerSettings = (HashMap<String, String>) this.inputConfig
		...
		if (this.inputConfig.containsKey("encoding")) {
			this.encoding = (String) this.inputConfig.get("encoding");
		} else {
			this.encoding = "UTF8";
		}
	}
	...
	public void emit() {
		...
		Map<String, Integer> topics = (Map<String, Integer>) this.inputConfig
				.get("topic");
